...
var videosReducer = function videosReducer() {
  ...
  switch (action.type) {
    ...
    case actionTypes.GET_TRENDING_VIDEOS:
      return videosReducer_objectSpread(videosReducer_objectSpread({}, state), {}, {
        trendingVideosLoading: true,
        trendingVideosLoadingError: false
      });
    case actionTypes.GET_TRENDING_VIDEOS_SUCCESS:
      return videosReducer_objectSpread(videosReducer_objectSpread({}, state), {}, {
        trendingVideosLoading: false,
        trendingVideos: action.trendingVideos
      });
    case actionTypes.GET_TRENDING_VIDEOS_ERROR:
      return videosReducer_objectSpread(videosReducer_objectSpread({}, state), {}, {
    ...
    case actionTypes.DOWNLOAD_VIDEO_PROGRESS:
      return videosReducer_objectSpread(videosReducer_objectSpread({}, state), {}, {
        downloadingVideo: true,
        videoDownloadingError: false,
    ...
    case actionTypes.DOWNLOAD_VIDEO_ERROR:
      return videosReducer_objectSpread(videosReducer_objectSpread({}, state), {}, {
        downloadingVideo: false,
...
var App = /*#__PURE__*/function (_Component) {
  ...
  function App() {
    ...
    (0,defineProperty["default"])((0,assertThisInitialized["default"])(_this), "loadTrendingVideos", /*#__PURE__*/(0,asyncToGenerator["default"])( /*#__PURE__*/regenerator_default().mark(function _callee2() {
      return regenerator_default().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _this.props.getTrendingVideos();
            case 2:
            case "end":
              return _context2.stop();
          }
    ...
    (0,defineProperty["default"])((0,assertThisInitialized["default"])(_this), "updateHomeFirstLoad", function (state) {
      _this.setState({
  ...
  (0,createClass["default"])(App, [{
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
        ...
        loginLoading = _this$state2.loginLoading,
...
var App_mapStateToProps = function mapStateToProps(state) {
  return App_objectSpread({}, state.videos);
};
var App_mapDispatchToProps = {
  getTrendingVideos: videosActions.getTrendingVideos
};
...
/* harmony export */   "DOWNLOAD_VIDEO": () => (/* binding */ DOWNLOAD_VIDEO),
/* harmony export */   "DOWNLOAD_VIDEO_ERROR": () => (/* binding */ DOWNLOAD_VIDEO_ERROR),
/* harmony export */   "DOWNLOAD_VIDEO_PROGRESS": () => (/* binding */ DOWNLOAD_VIDEO_PROGRESS),
/* harmony export */   "DOWNLOAD_VIDEO_SUCCESS": () => (/* binding */ DOWNLOAD_VIDEO_SUCCESS),
...
/* harmony export */   "GET_TRENDING_VIDEOS": () => (/* binding */ GET_TRENDING_VIDEOS),
/* harmony export */   "GET_TRENDING_VIDEOS_ERROR": () => (/* binding */ GET_TRENDING_VIDEOS_ERROR),
/* harmony export */   "GET_TRENDING_VIDEOS_SUCCESS": () => (/* binding */ GET_TRENDING_VIDEOS_SUCCESS),
...
var GET_TRENDING_VIDEOS = 'GET_TRENDING_VIDEOS';
var GET_TRENDING_VIDEOS_SUCCESS = 'GET_TRENDING_VIDEOS_SUCCESS';
var GET_TRENDING_VIDEOS_ERROR = 'GET_TRENDING_VIDEOS_ERROR';
var DOWNLOAD_VIDEO = 'DOWNLOAD_VIDEO';
var DOWNLOAD_VIDEO_SUCCESS = 'DOWNLOAD_VIDEO_SUCCESS';
var DOWNLOAD_VIDEO_PROGRESS = 'DOWNLOAD_VIDEO_PROGRESS';
var DOWNLOAD_VIDEO_ERROR = 'DOWNLOAD_VIDEO_ERROR';
...
var getTrendingVideos = function getTrendingVideos() {
  return /*#__PURE__*/function () {
    var _ref5 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee5(dispatch) {
      var url, res, trendingVideos;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              dispatch({
                type: _actionTypes__WEBPACK_IMPORTED_MODULE_5__.GET_TRENDING_VIDEOS
              });
              _context5.prev = 1;
              url = '/api/trending/';
              _context5.next = 5;
            ...
            case 5:
              res = _context5.sent;
              if (res.statusText === 'OK') {
                trendingVideos = res.data.trending_videos;
                dispatch({
                  type: _actionTypes__WEBPACK_IMPORTED_MODULE_5__.GET_TRENDING_VIDEOS_SUCCESS,
                  trendingVideos: trendingVideos
                });
              } else {
                dispatch({
                  type: _actionTypes__WEBPACK_IMPORTED_MODULE_5__.GET_TRENDING_VIDEOS_ERROR
                });
              }
              _context5.next = 12;
              break;
...
var downloadVideo = function downloadVideo(videoObj) {
  return /*#__PURE__*/function () {
    var _ref6 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee6(dispatch) {
      var url, slug, res, objectUrl, link;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              dispatch({
                type: _actionTypes__WEBPACK_IMPORTED_MODULE_5__.DOWNLOAD_VIDEO
              });
              _context6.prev = 1;
              url = videoObj.url, slug = videoObj.slug;
              _context6.next = 5;
              return axios__WEBPACK_IMPORTED_MODULE_2___default()({
                ...
                onDownloadProgress: function onDownloadProgress(progressEvent) {
                  ...
                  dispatch({
                    type: _actionTypes__WEBPACK_IMPORTED_MODULE_5__.DOWNLOAD_VIDEO_PROGRESS,
            ...
            case 5:
              ...
              if (res.statusText === 'OK') {
                ...
                dispatch({
                  type: _actionTypes__WEBPACK_IMPORTED_MODULE_5__.DOWNLOAD_VIDEO_ERROR
                });
              }
              _context6.next = 12;
              break;
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@tailwind base;\n@tailwind components;\n@tailwind utilities;\n\n* {\n\tmargin: 0;\n\tpadding: 0;\n\tbox-sizing: border-box;\n}\n\nhtml,\nbody {\n\tfont-family: 'Plus Jakarta Sans', sans-serif;\n\t-webkit-font-smoothing: antialiased;\n\t-moz-osx-font-smoothing: grayscale;\n\tbackground-color: #fff !important;\n}\n", "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA,cAAc;AACd,oBAAoB;AACpB,mBAAmB;;AAEnB;CACC,SAAS;CACT,UAAU;CACV,sBAAsB;AACvB;;AAEA;;CAEC,4CAA4C;CAC5C,mCAAmC;CACnC,kCAAkC;CAClC,iCAAiC;AAClC","sourcesContent":["@tailwind base;\n@tailwind components;\n@tailwind utilities;\n\n* {\n\tmargin: 0;\n\tpadding: 0;\n\tbox-sizing: border-box;\n}\n\nhtml,\nbody {\n\tfont-family: 'Plus Jakarta Sans', sans-serif;\n\t-webkit-font-smoothing: antialiased;\n\t-moz-osx-font-smoothing: grayscale;\n\tbackground-color: #fff !important;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
//# sourceMappingURL=main.90459ba044ce1f0bed3c.js.map