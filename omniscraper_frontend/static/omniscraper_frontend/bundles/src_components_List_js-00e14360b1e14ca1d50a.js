...
/***/ 1753:
/*!*********************************************************************!*\
  !*** ./node_modules/@mui/material/MenuItem/MenuItem.js + 3 modules ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 347:
/*!**********************************************!*\
  !*** ./src/components/List.js + 121 modules ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function useScrollTrigger(options = {}) {
  const {
    ...
    target = defaultTarget
        ...
        other = (0,objectWithoutPropertiesLoose.default)(options, useScrollTrigger_excluded);
...
function getTranslateValue(direction, node, resolvedContainer) {
  ...
  const containerWindow = (0,ownerWindow.default)(node);
  let transform;
...
const defaultEasing = {
  enter: createTransitions.easing.easeOut,
  exit: createTransitions.easing.sharp
};
const defaultTimeout = {
  enter: createTransitions.duration.enteringScreen,
  exit: createTransitions.duration.leavingScreen
...
const Slide = /*#__PURE__*/react.forwardRef(function Slide(props, ref) {
  const {
    ...
    TransitionComponent = Transition.default
        ...
        other = (0,objectWithoutPropertiesLoose.default)(props, Slide_excluded);

  const theme = (0,useTheme.default)();
  const childrenRef = react.useRef(null);
  const handleRefIntermediary = (0,useForkRef.default)(children.ref, childrenRef);
  const handleRef = (0,useForkRef.default)(handleRefIntermediary, ref);
  ...
  react.useEffect(() => {
    ...
    const containerWindow = (0,ownerWindow.default)(childrenRef.current);
    containerWindow.addEventListener('resize', handleResize);
    return () => {
      handleResize.clear();
      containerWindow.removeEventListener('resize', handleResize);
...
= {
   ...
   */
  container: (0,chainPropTypes.default)(prop_types_default().oneOfType([HTMLElementType.default, (prop_types_default()).func]), props => {
    if (props.open) {
...
function Blank(_ref) {
  ...
  return /*#__PURE__*/react.createElement(Slide_Slide, {
    appear: false,
    direction: "down",
    "in": !trigger
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/components/Instructions.css
var Instructions = __webpack_require__(3939);
;// CONCATENATED MODULE: ./src/components/Instructions.css
...
var update = injectStylesIntoStyleTag_default()(Instructions.default, options);



/* harmony default export */ const components_Instructions = (Instructions.default.locals || {});
...
function Instructions_Instructions(_ref) {
  var window = _ref.window;
...
/* harmony default export */ const src_components_Instructions = (Instructions_Instructions);
...
List_options.singleton = false;

var List_update = injectStylesIntoStyleTag_default()(List.default, List_options);
...
Spinner_options.insert = "head";
Spinner_options.singleton = false;
...
const PopperTooltip = /*#__PURE__*/react.forwardRef(function PopperTooltip(props, ref) {
  ...
  const ownRef = (0,esm_useForkRef.default)(tooltipRef, ref);
  const popperRef = react.useRef(null);
  const handlePopperRef = (0,esm_useForkRef.default)(popperRef, popperRefProp);
...
const TextareaAutosize = /*#__PURE__*/react.forwardRef(function TextareaAutosize(props, ref) {
  ...
  const inputRef = react.useRef(null);
  const handleRef = (0,esm_useForkRef.default)(ref, inputRef);
  const shadowRef = react.useRef(null);
  const renders = react.useRef(0);
  const [state, setState] = react.useState({});
  const syncHeight = react.useCallback(() => {
    const input = inputRef.current;
    const containerWindow = (0,esm_ownerWindow.default)(input);
  ...
  react.useEffect(() => {
    ...
    const containerWindow = (0,esm_ownerWindow.default)(inputRef.current);
    containerWindow.addEventListener('resize', handleResize);
    let resizeObserver;
...
const InputBase = /*#__PURE__*/react.forwardRef(function InputBase(inProps, ref) {
  ...
  const handleInputPropsRefProp = (0,useForkRef.default)(inputPropsProp.ref, handleInputRefWarning);
  const handleInputRefProp = (0,useForkRef.default)(inputRefProp, handleInputPropsRefProp);
  const handleInputRef = (0,useForkRef.default)(inputRef, handleInputRefProp);
  const [focused, setFocused] = react.useState(false);
  const muiFormControl = useFormControl();
...
var Tags = /*#__PURE__*/react.lazy(function () {
  return __webpack_require__.e(/*! import() */ "src_components_Tags_js").then(__webpack_require__.bind(__webpack_require__, /*! ./Tags */ 550));
});
...
var List_List = /*#__PURE__*/function (_Component) {
  ...
  (0,createClass.default)(List, [{
    ...
    value: function render() {
      ...
      var reportDialog = /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(reusableComponents_Modal, {
        type: "report",
        open: open,
      ...
      var editVideoTagsDialog = /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(reusableComponents_Modal, {
        type: "editVideo",
        open: tagsDialogOpen,
      ...
      var createTagDialog = /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(reusableComponents_Modal, {
        type: "createTag",
      ...
      return /*#__PURE__*/react.createElement("div", {
      ...
      }, "Add/Remove tags")), /*#__PURE__*/react.createElement(Tags, {
        ...
        xs: 12,
        sm: 12
      }, /*#__PURE__*/react.createElement(src_components_Instructions, null))), /*#__PURE__*/react.createElement(Grid_Grid, {
        item: true,
        md: 9,
        xs: 12,
        sm: 12,
        ...
        return /*#__PURE__*/react.createElement(Grid_Grid, {
          ...
          rightButton: loggedIn && /*#__PURE__*/react.createElement(Button.default, {
            type: "icon",
...
/* harmony default export */ const src_components_List = ((0,es.connect)(mapStateToProps, mapDispatchToProps)((0,react_router.withRouter)((0,withStyles.default)(List_styles)(withMobileDialog()(List_List)))));
...
/***/ 3939:
/*!*******************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/components/Instructions.css ***!
  \*******************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".container {\r\n  display: grid;\r\n  place-items: center;\r\n  text-align: center;\r\n}\r\n.paper {\r\n  padding: 8px;\r\n  display: flex;\r\n  justify-content: center;\r\n  width: 200px;\r\n}\r\n.typography {\r\n  margin-top: 4px;\r\n  line-height: 1.5;\r\n}\r\n.icons {\r\n  font-size: 50px;\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/components/Instructions.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,mBAAmB;EACnB,kBAAkB;AACpB;AACA;EACE,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,YAAY;AACd;AACA;EACE,eAAe;EACf,gBAAgB;AAClB;AACA;EACE,eAAe;AACjB","sourcesContent":[".container {\r\n  display: grid;\r\n  place-items: center;\r\n  text-align: center;\r\n}\r\n.paper {\r\n  padding: 8px;\r\n  display: flex;\r\n  justify-content: center;\r\n  width: 200px;\r\n}\r\n.typography {\r\n  margin-top: 4px;\r\n  line-height: 1.5;\r\n}\r\n.icons {\r\n  font-size: 50px;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=src_components_List_js-00e14360b1e14ca1d50a.js.map